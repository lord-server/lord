	...
	if expand then
		...
		def.after_dig_node = def.after_dig_node or function(pos, oldnode, oldmetadata, digger)
			...
			if expand.right and expand.forward ~= "air" then
				local right_pos = { x=pos.x+lord_homedecor.fdir_to_right[fdir+1][1], y=pos.y, z=pos.z+lord_homedecor.fdir_to_right[fdir+1][2] }
			...
			if expand.forward and expand.forward ~= "air" then
				local forward_pos = { x=pos.x+lord_homedecor.fdir_to_fwd[fdir+1][1], y=pos.y, z=pos.z+lord_homedecor.fdir_to_fwd[fdir+1][2] }
