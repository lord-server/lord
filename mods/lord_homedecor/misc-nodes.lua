...
--lord_homedecor.register("ceiling_paint", {
...
--lord_homedecor.register("ceiling_tile", {
...
--for i in ipairs(rug_types) do
	...
	--lord_homedecor.register("rug_"..s, {
		--description = S("Rug ("..s..")"),
		--mesh = mesh,
		--tiles = tiles,
		--node_box = nodebox,
...
--lord_homedecor.register("pole_brass", {
...
--lord_homedecor.register("fishtank", {
	...
	--on_rightclick = function(pos, node, clicker)
		--minetest.set_node(pos, {name = "lord_homedecor:fishtank_lighted", param2 = node.param2})
	--end
--})

--lord_homedecor.register("fishtank_lighted", {
	...
	--sounds = default.node_sound_glass_defaults(),
	--on_rightclick = function(pos, node, clicker)
		--minetest.set_node(pos, {name = "lord_homedecor:fishtank", param2 = node.param2})
	--end,
	--drop = "lord_homedecor:fishtank",
--})

--lord_homedecor.register("cardboard_box_big", {
...
--lord_homedecor.register("cardboard_box", {
...
--lord_homedecor.register("dvd_cd_cabinet", {
	...
	--},
	--selection_box = lord_homedecor.nodebox.slab_z(-0.5),
...
--lord_homedecor.register("pool_table", {
...
--minetest.register_alias("lord_homedecor:pool_table_2", "air")
...
--minetest.register_alias("lord_homedecor:piano_left", "lord_homedecor:piano")
--minetest.register_alias("lord_homedecor:piano_right", "air")
...
--lord_homedecor.register("trophy", {
	--description = "Trophy",
...
--lord_homedecor.register("sportbench", {
...
--lord_homedecor.register("skateboard", {
	--drawtype = "mesh",
...
--lord_homedecor.register("tool_cabinet", {
...
--minetest.register_alias("lord_homedecor:tool_cabinet_bottom", "lord_homedecor:tool_cabinet")
--minetest.register_alias("lord_homedecor:tool_cabinet_top", "air")
...
--for _, i in ipairs(n) do
	--lord_homedecor.register("picture_frame"..i, {
...
--for i = 1,20 do
	--lord_homedecor.register("painting_"..i, {
...
lord_homedecor.banister_materials = {
	...
	--{	"white_dark",
		--"dark topped",
		--lord_homedecor.white_wood,
		--lord_homedecor.dark_wood,
		--"group:wood",
		--"group:stick",
		--"dye:brown",
		--"dye:white"
...
--lord_homedecor.register("spiral_staircase", {
	...
	--after_place_node = function(pos, placer, itemstack, pointed_thing)
		...
		--local leftx =  lord_homedecor.fdir_to_left[fdir+1][1]
		--local leftz =  lord_homedecor.fdir_to_left[fdir+1][2]
		--local revx  = -lord_homedecor.fdir_to_fwd[fdir+1][1]
		--local revz  = -lord_homedecor.fdir_to_fwd[fdir+1][2]
		...
		--if belownode and belownode.name == "lord_homedecor:spiral_staircase" then
			--local newpos = { x = pos.x, y = pos.y + 2, z = pos.z }
			--minetest.set_node(pos, { name = "air" })
			--minetest.set_node(newpos, { name = "lord_homedecor:spiral_staircase", param2 = belownode.param2 })
		--end
	--end
--})
...
--minetest.register_on_placenode(function(pos, newnode, placer, oldnode, itemstack, pointed_thing)
	...
	--if newnode.name ~= "lord_homedecor:spiral_staircase"
	  --and belownode
	  --and belownode.name == "lord_homedecor:spiral_staircase" then
		--minetest.set_node(pos, { name = "air" })
