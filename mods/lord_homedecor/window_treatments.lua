...
--lord_homedecor.register("window_quartered", {
...
--lord_homedecor.register("window_plain", {
...
--lord_homedecor.register("blinds_thick", {
...
--lord_homedecor.register("blinds_thin", {
...
--for c in ipairs(curtaincolors) do
	...
	--lord_homedecor.register("curtain_"..color, {
	...
	---- Open the curtains
		--on_rightclick = function(pos, node, clicker, itemstack)
			...
			--if string.find(topnode.name, "lord_homedecor:curtainrod") then
				--local fdir = node.param2
				--minetest.set_node(pos, { name = "lord_homedecor:curtain_open_"..color, param2 = fdir })
			--end
		--end
	--})

	--lord_homedecor.register("curtain_open_"..color, {
		--description = S("Curtains (%s)"):format(color_d),
	...
	---- Close the curtains
		--on_rightclick = function(pos, node, clicker, itemstack)
			...
			--if string.find(topnode.name, "lord_homedecor:curtainrod") then
				--local fdir = node.param2
				--minetest.set_node(pos, { name = "lord_homedecor:curtain_"..color, param2 = fdir })
			--end
		--end
	--})
...
--for i in ipairs(mats) do
	...
	--lord_homedecor.register("curtainrod_"..material, {
		--tiles = { texture },
