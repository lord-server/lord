...
-- - possible_items - таблица-массив со stackstring предметов, которые могут появиться в целевом сундуке.
	...
	minetest.register_abm({
		...
		action = function(pos, node, active_object_count, active_object_count_wider)
			...
			for i = 1, number_of_items do
				...
				local item_idx = math.random(#possible_items)
				inv:set_stack("main", stack_idx, possible_items[item_idx])
			end
		end,
	})
end
