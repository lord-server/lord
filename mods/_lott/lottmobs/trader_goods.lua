...
lottmobs.hobbit = {
	items = {
		...
		{"lottfarming:tomato "..math.random(20,30),			"lord_money:silver_coin 23",	25},
		...
		{"lottfarming:barley "..math.random(5,10),				"lord_money:silver_coin 3",	14},
	...
	items_race = {
		...
		{"lottfarming:tomato "..math.random(20,30),		"lord_money:silver_coin 20",	25},
