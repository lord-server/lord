...
If you want to remove object from the storage, call util.kv_set(key, nil)

I don't recommend to save manually because it saves automatically every N seconds
Also don't forget to add `lord_util` to your depends.txt
--]]
if not minetest.global_exists("util") then
	util = {}
end
...
-- Trigger util.kv_save() every SAVE_INTERVAL seconds
