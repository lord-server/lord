...
overwrite("farming:bread", 9)

if minetest.get_modpath("lottfarming") ~= nil then
	overwrite("lottfarming:berries", 1, "", 1)
	overwrite("lottfarming:berry_cake", 4, "", 1)
