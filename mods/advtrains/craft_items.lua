...
-- })
-- core.register_craftitem("advtrains:wheel_pair", {
-- 	description = attrans("Wheel pair"),
-- 	inventory_image = "advtrains_wheel_pair.png",
-- })
--
-- core.register_craftitem("advtrains:trolley", {
-- 	description = attrans("Carriage trolley"),
-- 	inventory_image = "advtrains_carriage_trolley.png",
-- })
--
