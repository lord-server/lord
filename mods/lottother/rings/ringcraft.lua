...
minetest.register_craftitem("lottother:blue_rr_ring", {
	description = SL("Coated Tansanite Ring"),
...
minetest.register_craftitem("lottother:red_rr_ring", {
	description = SL("Coated Ruby Ring"),
...
minetest.register_craftitem("lottother:purple_rr_ring", {
	description = SL("Coated Ilvanite Ring"),
...
minetest.register_craftitem("lottother:white_rr_ring", {
	description = SL("Coated Adamant Ring"),
...
minetest.register_craft({
	...
	recipe = {
	{"lottother:ringsilver", "lottother:ringsilver", "lottother:ringsilver"},
	{"lottother:ringsilver", "lottother:ringsilver", "lottother:ringsilver"},
	{"lottother:ringsilver", "lottother:ringsilver", "lottother:ringsilver"},
	},
})
...
minetest.register_craft({
	output = "lottother:goldsilver_block",
	recipe = {
	{"lottother:goldsilver", "lottother:goldsilver", "lottother:goldsilver"},
	{"lottother:goldsilver", "lottother:goldsilver", "lottother:goldsilver"},
	{"lottother:goldsilver", "lottother:goldsilver", "lottother:goldsilver"},
	},
})

minetest.register_node("lottother:goldsilver_block", {
	description = SL("Electrum Block"),
	tiles = {"lottother_goldsilver_block.png"},
	is_ground_content = true,
	groups = {cracky=2},
	sounds = default.node_sound_metal_defaults(),
})
...
minetest.register_craft({
	...
	recipe = {
	{"lottother:pure_silver", "lottother:pure_silver", "lottother:pure_silver"},
	{"lottother:pure_silver", "lottother:pure_silver", "lottother:pure_silver"},
	{"lottother:pure_silver", "lottother:pure_silver", "lottother:pure_silver"},
	},
})

minetest.register_node("lottother:pure_silver_block", {
	description = SL("Pure Silver Block"),
	tiles = {"lottother_pure_silver_block.png"},
	is_ground_content = true,
	groups = {cracky=2},
	sounds = default.node_sound_metal_defaults(),
})
...
minetest.register_node("lottother:pure_gold_block", {
	description = SL("Pure Gold Block"),
	tiles = {"lottother_pure_gold_block.png"},
	is_ground_content = true,
	groups = {cracky=2},
	sounds = default.node_sound_metal_defaults(),
})
