...
core.mod(function(mod)
	...
	if not core.get_modpath('worldedit_commands') then
		mod.logger.warning('Mod not loaded due to lack of mod `worldedit_commands`')
	...
	if core.get_modpath('worldedit_shortcommands') then
