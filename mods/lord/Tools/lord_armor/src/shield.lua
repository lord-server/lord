...
minetest.register_tool(":lottarmor:shield_wood", {
	...
	groups          = {
		armor_shield = 2.5, armor_heal = 0, armor_use = 2000, physics_speed = 0.2, wooden = 1
	},
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_tin", {
	...
	groups          = { armor_shield = 5, armor_heal = 0, armor_use = 1750, tin_item = 1 },
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_copper", {
	...
	groups          = { armor_shield = 5, armor_heal = 0, armor_use = 1750, copper_item = 1 },
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_steel", {
	...
	groups          = { armor_shield = 10, armor_heal = 0, armor_use = 1250, steel_item = 1 },
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_bronze", {
	...
	groups          = { armor_shield = 12, armor_heal = 6, armor_use = 750, bronze_item = 1 },
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_silver", {
	...
	groups          = {
		armor_shield = 15, armor_heal = 6, armor_use = 1000, physics_speed = -0.05, silver_item = 1
	},
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_gold", {
	...
	groups          = {
		armor_shield = 15, armor_heal = 12, armor_use = 500, physics_speed = -0.05, gold_item = 1
	},
	wear            = 0,
})
...
minetest.register_tool(":lottarmor:shield_galvorn", {
	...
	groups          = {
		armor_shield  = 15, armor_heal = 12, armor_use = 250,
...
minetest.register_tool(":lottarmor:shield_mithril", {
	...
	groups          = {
		armor_shield  = 25, armor_heal = 12, armor_use = 100,
