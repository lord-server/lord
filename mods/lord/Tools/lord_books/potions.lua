	...
	if page=="potions" then
     ...
     if page=="potions4" then
		return "size[8,5.5]"
               ...
               .."item_image_button[5,2;1,1;lord_trees:yavannamireleaf;zcg:yavannamireleaf;10]"
               .."image[6,2;1,1;books_craft_arrow.png]"
               ...
               .."item_image_button[5,3;1,1;lord_trees:yavannamireleaf;zcg:yavannamireleaf;10]"
               .."image[6,3;1,1;books_craft_arrow.png]"
               ...
               .."item_image_button[5,4;1,1;lord_trees:yavannamireleaf;zcg:yavannamireleaf;10]"
               .."image[6,4;1,1;books_craft_arrow.png]"
     ...
     if page=="potions5" then
		return "size[8,5.5]"
               ...
               .."label[1,2.2; "..SL("Power Level")..": 1]"
               .."item_image_button[4,2;1,1;lottpotion:glass_bottle_mese;zcg:glass_bottle_mese;]"
               .."item_image_button[5,2;1,1;lord_trees:yavannamirefruit;zcg:yavannamirefruit;2]"
               .."image[6,2;1,1;books_craft_arrow.png]"
               ...
               .."item_image_button[5,3;1,1;lord_trees:yavannamirefruit;zcg:yavannamirefruit;2]"
               .."image[6,3;1,1;books_craft_arrow.png]"
               ...
               .."item_image_button[5,4;1,1;lord_trees:yavannamirefruit;zcg:yavannamirefruit;2]"
               .."image[6,4;1,1;books_craft_arrow.png]"
