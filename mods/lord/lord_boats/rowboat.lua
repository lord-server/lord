...
function row_boat.on_detach_child(self, child)
	self.driver = nil
	self.auto = false
end
...
function row_boat.on_punch(self, puncher)
	...
	if not self.driver then
		...
		if not minetest.is_creative_enabled(name)
				or not inv:contains_item("main", "lord_boats:row_boat") then
			local leftover = inv:add_item("main", "lord_boats:row_boat")
...
minetest.register_entity("lord_boats:row_boat", row_boat)


minetest.register_craftitem("lord_boats:row_boat", {
