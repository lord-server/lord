...
function sail_boat.on_punch(self, puncher)
	...
	if not self.driver then
		...
		if not minetest.is_creative_enabled(name)
				or not inv:contains_item("main", "lord_boats:sail_boat") then
			local leftover = inv:add_item("main", "lord_boats:sail_boat")
...
minetest.register_entity("lord_boats:sail_boat", sail_boat)


minetest.register_craftitem("lord_boats:sail_boat", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		sail_boat = minetest.add_entity(pointed_thing.under, "lord_boats:sail_boat")
		if sail_boat then
			if placer then
