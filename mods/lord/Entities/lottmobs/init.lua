...
mobs:register_mob("lottmobs:ent", {
	...
	drops = {
		...
		{ name = "lord_trees:aldersapling",       chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:applesapling",       chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:birchsapling",       chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:beechsapling",       chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:culumaldasapling",   chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:elmsapling",         chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:lebethronsapling",   chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:plumsapling",        chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:rowansapling",       chance = 5, min = 1, max = 3, },
		{ name = "lord_trees:yavannamiresapling", chance = 250, min = 1, max = 1, },
		-- { name = "lord_trees:cherrysapling",      chance = 250, min = 1, max = 1, },
	},
...
mobs:register_mob("lottmobs:gondor_guard", {
	...
	drops = {
		...
		{ name = "default:steel_sword",           chance = 10,  min = 1, max = 1, },
		{ name = "lord_trees:whitesapling",       chance = 250, min = 1, max = 1, },
...
mobs:register_mob("lottmobs:hobbit", {
	...
	drops = {
		...
		{ name = "lottpotion:ale",              chance = 20, min = 1, max = 5, },
		{ name = "lottpotion:wine",             chance = 20, min = 1, max = 5, },
		{ name = "lottpotion:beer",             chance = 20, min = 1, max = 5, },
		{ name = "lottpotion:cider",            chance = 20, min = 1, max = 5, },
	},
	light_resistant = true,
	drawtype = "front",
	water_damage = 1,
...
mobs:register_mob("lottmobs:orc", {
	...
	drops = {
		...
		{ name = "lottpotion:wine",          chance = 26, min = 1, max = 2, },
	},
	light_resistant = true,
	drawtype = "front",
	water_damage = 5,
