...
dofile(minetest.get_modpath("lottmobs").."/src/traders.lua")
...
mobs:register_mob("lottmobs:ent", {
	...
	drops = {
		...
		{ name = "lottplants:aldersapling",       chance = 5, min = 1, max = 3, },
		{ name = "lottplants:applesapling",       chance = 5, min = 1, max = 3, },
		{ name = "lottplants:birchsapling",       chance = 5, min = 1, max = 3, },
		{ name = "lottplants:beechsapling",       chance = 5, min = 1, max = 3, },
		{ name = "lottplants:culumaldasapling",   chance = 5, min = 1, max = 3, },
		{ name = "lottplants:elmsapling",         chance = 5, min = 1, max = 3, },
		{ name = "lottplants:lebethronsapling",   chance = 5, min = 1, max = 3, },
...
mobs:register_mob("lottmobs:gondor_guard", {
	...
	drops = {
		...
		{ name = "default:steel_sword",           chance = 10,  min = 1, max = 1, },
		{ name = "lottplants:whitesapling",       chance = 250, min = 1, max = 1, },
