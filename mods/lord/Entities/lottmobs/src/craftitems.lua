...
core.register_craftitem("lottmobs:meat", {
...
core.register_craftitem("lottmobs:meat_raw", {
...
core.register_craftitem("lottmobs:pork_raw", {
...
core.register_craftitem("lottmobs:pork_cooked", {
...
core.register_craftitem("lottmobs:spiderpoison", {
	description = S("Spider Poison"),
	inventory_image = "lottmobs_spiderpoison.png",
})


core.register_craftitem("lottmobs:fish_raw", {
...
core.register_craftitem("lottmobs:horsemeat_raw", {
...
core.register_craftitem("lottmobs:chicken_raw", {
...
core.register_craftitem("lottmobs:rabbit_raw", {
...
core.register_craftitem("lottmobs:fish_cooked", {
	description     = S("Cooked Fish"),
	inventory_image = "lottmobs_fish_cooked.png",
	on_use          = core.item_eat(11),
	_tt_food_hp     = 11,
})

core.register_craftitem("lottmobs:horsemeat_cooked", {
...
core.register_craftitem("lottmobs:chicken_cooked", {
...
core.register_craftitem("lottmobs:rabbit_cooked", {
...
core.register_craftitem("lottmobs:rotten_meat", {
...
core.register_craftitem("lottmobs:fried_egg", {
