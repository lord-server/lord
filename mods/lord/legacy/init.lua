...
minetest.register_alias("lottfarming:athelas_seed", "lottfarming:seed_athelas")
minetest.register_alias("lottfarming:barley", "lottfarming:sheaf_barley")
minetest.register_alias("lottfarming:barley_seed", "lottfarming:barley")
...
minetest.register_alias("lottfarming:corn0", "lottfarming:corn_kernel")
minetest.register_alias("lottfarming:half_of_potatoe", "lottfarming:half_of_potato")
minetest.register_alias("lottfarming:melon_seed", "lottfarming:seed_melon")
minetest.register_alias("lottfarming:pipeweed_seed", "lottfarming:seed_pipeweed")
minetest.register_alias("lottfarming:potato_seed", "lottfarming:half_of_potato")
minetest.register_alias("lottfarming:tomatoes_seed", "lottfarming:seed_tomato")
minetest.register_alias("lottfarming:turnips_seed", "lottfarming:seed_turnip")

minetest.register_alias("lottfarming:tomatoes", "lottfarming:tomato")
minetest.register_alias("lottfarming:tomatoes_1", "lottfarming:tomato_1")
minetest.register_alias("lottfarming:tomatoes_2", "lottfarming:tomato_2")
minetest.register_alias("lottfarming:tomatoes_3", "lottfarming:tomato_3")
minetest.register_alias("lottfarming:tomatoes_4", "lottfarming:tomato_4")
minetest.register_alias("lottfarming:tomatoes_cooked", "lottfarming:tomato_cooked")

minetest.register_alias("lottfarming:turnips", "lottfarming:turnip")
minetest.register_alias("lottfarming:turnips_1", "lottfarming:turnip_1")
minetest.register_alias("lottfarming:turnips_2", "lottfarming:turnip_2")
minetest.register_alias("lottfarming:turnips_3", "lottfarming:turnip_3")
minetest.register_alias("lottfarming:turnips_4", "lottfarming:turnip_4")
minetest.register_alias("lottfarming:turnips_cooked", "lottfarming:turnip_cooked")

minetest.register_alias("lottfarming:blue_mushroom_spore", "lottfarming:spore_blue_mushroom")
minetest.register_alias("lottfarming:brown_mushroom_spore", "lottfarming:spore_brown_mushroom")
minetest.register_alias("lottfarming:green_mushroom_spore", "lottfarming:spore_green_mushroom")
minetest.register_alias("lottfarming:red_mushroom_spore", "lottfarming:spore_red_mushroom")
...
minetest.register_alias("lottplants:turnips_wild", "lottplants:turnip_wild")
minetest.register_alias("lottplants:tomatoes_wild", "lottplants:tomato_wild")
