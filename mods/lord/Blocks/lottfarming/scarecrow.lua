...
minetest.register_node('lottfarming:scarecrow', {
	description         = S('Scarecrow'),
	paramtype           = 'light',
	paramtype2          = 'facedir',
	sunlight_propagates = true,
	drawtype            = 'mesh',
	mesh                = 'lottfarming_scarecrow.obj',
	tiles               = { 'lottfarming_scarecrow.png' },
...
minetest.register_node('lottfarming:scarecrow_halloween', {
	...
	drawtype            = 'mesh',
	mesh                = 'lottfarming_scarecrow.obj',
	tiles               = { 'lottfarming_scarecrow.png^lottfarming_scarecrow_lightning_face.png' },
	use_texture_alpha   = 'clip',
	is_ground_content   = false,
	walkable            = true,
	selection_box       = {
...
minetest.register_craft({
	output = 'lottfarming:scarecrow_halloween',
	recipe = {
		{ '',              'farming:straw',                                 '' },
		{ 'group:stick',   'lottfarming:pumpkin_jack_o_lantern', 'group:stick' },
		{ '',              'lottmobs:dirty_shirt',                          '' },
	},
})
