...
core.register_craftitem("lottfarming:white_mushroom_spore", {
...
core.register_node("lottfarming:white_mushroom", {
...
core.register_node("lottfarming:white_mushroom_1", {
	paramtype = "light",
	paramtype2 = "meshoptions",
	light_source = 2,
	walkable = false,
...
core.register_node("lottfarming:white_mushroom_2", {
	paramtype = "light",
	paramtype2 = "meshoptions",
	light_source = 2,
	walkable = false,
...
core.register_node("lottfarming:white_mushroom_3", {
	paramtype = "light",
	paramtype2 = "meshoptions",
	light_source = 2,
	walkable = false,
...
core.register_node("lottfarming:white_mushroom_4", {
	paramtype = "light",
	paramtype2 = "meshoptions",
	light_source = 2,
	walkable = false,
...
core.register_abm({
	...
	action = function(pos, node)
		...
		core.set_node(pos, {name='lottfarming:white_mushroom_2', param2 = 9})
	end
}	)
core.register_abm({
	...
	action = function(pos, node)
		...
		core.set_node(pos, {name='lottfarming:white_mushroom_3', param2 = 9})
...
core.register_abm({
	...
	action = function(pos, node)
		pos.y = pos.y-1
		if core.get_node(pos).name ~= "lottfarming:decay_tree"
		and core.get_node(pos).name ~= "default:tree" then
			return
		end
		pos.y = pos.y+1
		if not core.get_node_light(pos) then
		...
		core.set_node(pos, {name='lottfarming:white_mushroom_4', param2 = 9})
