...
local function register_road(name, main_material, desc, fill) -- функция регистрации всех нодов дороги
  ...
  core.register_node(border_name, {
  ...
  core.register_node(border_name.."A", {
  ...
  core.register_node(border_name.."B", {
  ...
  core.register_node(border_name.."C", {
    ...
    core.register_node(border_name.."D", {
  ...
  core.register_node(inner_corner_border_name, {
  ...
  core.register_node(inner_corner_border_name.."A", {
  ...
  core.register_node(inner_corner_border_name.."B", {
  ...
  core.register_node(inner_corner_border_name.."C", {
  ...
  core.register_node(inner_corner_border_name.."D", {
  ...
  core.register_node(outer_corner_border_name, {
  ...
  core.register_node(outer_corner_border_name.."A", {
   ...
   core.register_node(outer_corner_border_name.."B", {
  ...
  core.register_node(outer_corner_border_name.."C", {
   ...
   core.register_node(outer_corner_border_name.."D", {
  ...
  core.register_node(step_road_name, {
  ...
  core.register_node(step_border_name, {
  ...
  core.register_node(step_border_name.."A", {
  ...
  core.register_node(step_border_name.."B", {
  ...
  core.register_node(step_border_name.."C", {
  ...
  core.register_node(step_border_name.."D", {
  ...
  core.register_craftitem(border_item_name, {
  description = S(desc.description.." border"),
