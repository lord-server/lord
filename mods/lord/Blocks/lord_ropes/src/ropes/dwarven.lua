...
local function register_dwarven()
	...
	minetest.register_node('lord_ropes:dwarven_box_rope', {
		drawtype = 'nodebox',
		paramtype = 'light',
		sunlight_propagates = true,
		tiles = {'lord_ropes_dwarven_ropes.png'},
		...
		after_destruct = function(pos,oldnode)
			...
			if node.name == 'lord_ropes:dwarven_box_rope' then
	...
	minetest.register_node('lord_ropes:dwarven_ropebox', {
		...
		drawtype = 'nodebox',
		sunlight_propagates = true,
		tiles = {'lord_ropes_dwarven_ropebox_top.png',
				'lord_ropes_dwarven_ropebox_top.png',
				'lord_ropes_dwarven_ropebox_side_1.png',
				'lord_ropes_dwarven_ropebox_side_1.png',
				'lord_ropes_dwarven_ropebox_side_2.png',
				'lord_ropes_dwarven_ropebox_side_2.png'},
		use_texture_alpha = 'clip',
		paramtype = 'light',
		paramtype2 = 'facedir',
	...
	minetest.register_abm({
		...
		if minetest.get_node({x=pos.x,y=pos.y-1,z=pos.z}).name ~= 'air'  then return end
				minetest.add_node({x=pos.x,y=pos.y-1,z=pos.z}, {name='lord_ropes:dwarven_box_rope'})
		end
	})

	minetest.register_abm({
		nodenames = {'lord_ropes:dwarven_box_rope'},
		interval = 1,
		chance = 1,
		action = function(pos, node)
		if minetest.get_node({x=pos.x,y=pos.y-1,z=pos.z}).name ~= 'air'  then return end
