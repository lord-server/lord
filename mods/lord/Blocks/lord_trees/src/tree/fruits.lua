...
core.register_node("lord_trees:plum", {
	description         = S("Plum"),
	drawtype            = "plantlike",
	visual_scale        = 1.0,
	...
	after_place_node    = function(pos, placer, itemstack)
		if placer:is_player() then
			core.set_node(pos, { name = "lord_trees:plum", param2 = 1 })
		end
	end,
})

core.register_node("lord_trees:yavannamire_fruit", {
	...
	after_place_node    = function(pos, placer, itemstack)
		if placer:is_player() then
			core.set_node(pos, { name = "lord_trees:yavannamire_fruit", param2 = 1 })
		end
	end,
})
