...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_alder_tree',
	},
...
default.register_leafdecay({
	trunks = {
		'default:tree',
		'lord_trees:infected_apple_tree',
	},
	leaves = {
...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_lebethron_tree',
	},
...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_birch_tree',
	},
...
default.register_leafdecay({
	trunks = {
		'lord_trees:cherry_tree',
		'lord_trees:infected_cherry_tree',
	},
...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_mallorn_tree',
	},
...
default.register_leafdecay({
	trunks = {
		'lord_trees:beech_tree',
		'lord_trees:infected_beech_tree',
	},
...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_white_tree',
	},
...
default.register_leafdecay({
	trunks = {
		...
		'lord_trees:infected_yavannamire_tree',
	},
