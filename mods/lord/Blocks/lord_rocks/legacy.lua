...
minetest.register_alias("lottmapgen:mordor_stone",       "lord_rocks:mordor_stone")

-- DEFAULTS (Ghost blocks)
minetest.register_alias("defaults:lottmapgen_frozen_stone",       "defaults:lord_rocks_frozen_stone")
minetest.register_alias("defaults:lottmapgen_mordor_stone",       "defaults:lord_rocks_mordor_stone")
