...
local Form = {
	get_spec = function(type, percent, item_percent)
		...
		local bubbles_image = type == 'inactive'
			and 'image[4,2;1,1;benches_form_bubble_off.png]'
			or  'image[4,2;1,1;benches_form_bubble_off.png^[lowpart:' .. (percent) .. ':benches_form_bubble.png]'


		return 'size[8,9]' ..
			'label[0,0;' .. S('Laboratory') .. ']' ..
			bubbles_image ..
