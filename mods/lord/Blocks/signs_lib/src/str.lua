...
local function AnsiToUtf8(s) -- luacheck: ignore unused global variable AnsiToUtf8
	local r, b = ''
...
local function trim_to(text, max_len)
	return text:sub(1, math.min(max_len, text:len()))
end
