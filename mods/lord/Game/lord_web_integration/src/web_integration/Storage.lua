...
--- @return number|nil
function Storage.get_clan_web_id(clan_name)
	return tonumber(Storage.mod_storage:get("clan:" .. clan_name .. ":web_id"))
end

--- @param clan_name string
--- @param web_id    number
function Storage.set_clan_web_id(clan_name, web_id)
	Storage.mod_storage:set_int("clan:" .. clan_name .. ":web_id", web_id)
end
