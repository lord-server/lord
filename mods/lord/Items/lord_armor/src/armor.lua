...
minetest.register_tool(":lottarmor:helmet_wood", {
	...
	groups = {armor_head=1, defense_fleshy=4, armor_use=2000, physics_speed=0.05, wooden = 1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_wood", {
	...
	groups = {armor_torso=1, defense_fleshy=5, armor_use=2000, physics_speed=0.06, wooden = 1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_wood", {
	...
	groups = {armor_legs=1, defense_fleshy=3, armor_use=2000, physics_speed=0.07, wooden = 1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_wood", {
	description = S("Training Boots"),
	inventory_image = "lottarmor_inv_boots_wood.png",
	groups = {armor_feet=1, defense_fleshy=2, armor_use=2100, physics_speed=0.08, wooden = 1},
	wear = 0,
})
...
minetest.register_tool(":lottarmor:helmet_tin", {
	...
	groups = {armor_head=1, defense_fleshy=6, damage_avoid_chance=1, armor_use=1500, physics_speed=0.02, tin_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_tin", {
	...
	groups = {armor_torso=1, defense_fleshy=7, damage_avoid_chance=1, armor_use=1500, physics_speed=0.02, tin_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_tin", {
	description = S("Tin Leggings"),
	inventory_image = "lottarmor_inv_leggings_tin.png",
	groups = {armor_legs=1, defense_fleshy=4, damage_avoid_chance=1, armor_use=1500, physics_speed=0.03, tin_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_tin", {
	description = S("Tin Boots"),
	inventory_image = "lottarmor_inv_boots_tin.png",
	groups = {armor_feet=1, defense_fleshy=3, damage_avoid_chance=0, armor_use=2000, physics_speed=0.03, tin_item=1},
	wear = 0,
})
...
minetest.register_tool(":lottarmor:helmet_copper", {
	...
	groups = {armor_head=1, defense_fleshy=8, damage_avoid_chance=1, armor_use=1500, physics_speed=0.02, copper_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_copper", {
	...
	groups = {armor_torso=1, defense_fleshy=10, damage_avoid_chance=1, armor_use=1500, physics_speed=0.025, copper_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_copper", {
	...
	groups = {armor_legs=1, defense_fleshy=6, damage_avoid_chance=1, armor_use=1500, physics_speed=0.04, copper_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_copper", {
	description = S("Copper Boots"),
	inventory_image = "lottarmor_inv_boots_copper.png",
	groups = {armor_feet=1, defense_fleshy=4, damage_avoid_chance=0, armor_use=2000, physics_speed=0.05, copper_item=1},
	wear = 0,
})
...
minetest.register_tool(":lottarmor:helmet_steel", {
	...
	groups = {armor_head=1, defense_fleshy=9, damage_avoid_chance=2, armor_use=500, physics_speed=0.015, steel_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_steel", {
	description = S("Steel Chestplate"),
	inventory_image = "lottarmor_inv_chestplate_steel.png",
	groups = {armor_torso=1, defense_fleshy=11, damage_avoid_chance=2, armor_use=500, physics_speed=0.02, steel_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_steel", {
	description = S("Steel Leggings"),
	inventory_image = "lottarmor_inv_leggings_steel.png",
	groups = {armor_legs=1, defense_fleshy=7, damage_avoid_chance=2, armor_use=500, physics_speed=0.03, steel_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_steel", {
	description = S("Steel Boots"),
	inventory_image = "lottarmor_inv_boots_steel.png",
	groups = {armor_feet=1, defense_fleshy=4, damage_avoid_chance=0, armor_use=500, physics_speed=0.04, steel_item=1},
	wear = 0,
})
...
minetest.register_tool(":lottarmor:helmet_bronze", {
	...
	groups = {armor_head=1, defense_fleshy=10, damage_avoid_chance=3, armor_use=250, physics_speed=0.02, bronze_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_bronze", {
	description = S("Bronze Chestplate"),
	inventory_image = "lottarmor_inv_chestplate_bronze.png",
	groups = {armor_torso=1, defense_fleshy=12, damage_avoid_chance=3, armor_use=250, physics_speed=0.03, bronze_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_bronze", {
	description = S("Bronze Leggings"),
	inventory_image = "lottarmor_inv_leggings_bronze.png",
	groups = {armor_legs=1, defense_fleshy=7, damage_avoid_chance=3, armor_use=250, physics_speed=0.04, bronze_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_bronze", {
	description = S("Bronze Boots"),
	inventory_image = "lottarmor_inv_boots_bronze.png",
	groups = {armor_feet=1, defense_fleshy=5, damage_avoid_chance=0, armor_use=250, physics_speed=0.05, bronze_item=1},
	wear = 0,
})
...
minetest.register_tool(":lottarmor:helmet_mithril", {
	...
	groups = {armor_head=1, defense_fleshy=14, damage_avoid_chance=0, armor_use=50, physics_speed=0.05, mithril_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:chestplate_mithril", {
	description = S("Mithril Chestplate"),
	inventory_image = "lottarmor_inv_chestplate_mithril.png",
	groups = {armor_torso=1, defense_fleshy=17, damage_avoid_chance=0, armor_use=50, physics_speed=0.05, mithril_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:leggings_mithril", {
	description = S("Mithril Leggings"),
	inventory_image = "lottarmor_inv_leggings_mithril.png",
	groups = {armor_legs=1, defense_fleshy=10, damage_avoid_chance=0, armor_use=50, physics_speed=0.06, mithril_item=1},
	wear = 0,
})
minetest.register_tool(":lottarmor:boots_mithril", {
	description = S("Mithril Boots"),
	inventory_image = "lottarmor_inv_boots_mithril.png",
	groups = {armor_feet=1, defense_fleshy=7, damage_avoid_chance=0, armor_use=50, physics_speed=0.07, mithril_item=1},
	wear = 0,
})
