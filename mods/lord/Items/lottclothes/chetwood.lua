...
-- cap (head)
core.register_tool("lottclothes:cap_chetwood", {
...
-- jacket (torso)
core.register_tool("lottclothes:jacket_chetwood", {
...
-- pants (legs)
core.register_tool("lottclothes:pants_chetwood", {
...
-- boots (feet)
core.register_tool("lottclothes:boots_chetwood", {
