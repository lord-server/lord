...
mobs:register_mob("lottmobs:nazgul", {
	...
	textures = {
		{"lottmobs_nazgul.png", "lottarmor_trans.png", "tools_sword_steel.png", "lottarmor_trans.png"},
	},
	visual_size = {x=2, y=2},
...
mobs:register_mob("lottmobs:witch_king", {
	...
	mesh = "human_model.x",
	textures = {
		{"lottmobs_witch_king.png", "lottarmor_trans.png", "tools_sword_steel.png", "lottarmor_trans.png"},
	},
	makes_footstep_sound = true,
	view_range = 15,
	walk_velocity = 1,
