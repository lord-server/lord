...
Code-Style
----------
см. [Code Style Guidelines](.guides/code-style.ru.md)
...
не забудьте добавить соответствующие изменения в файлы:
 - в `./minetest.conf.stage` -- для тестового сервера (stage)
 - в `./minetest.conf.stage-featured` -- для тестового с включенными фичами (stage-featured)
